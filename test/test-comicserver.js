...
function check(t, expected_file, options) {
  ...
  eq(t, actual, fs.readFileSync(expected_file, 'utf8'), expected_file)
}
...
test('comic works for all characters', function (t) {
  ...
  check(t, 'test/results/humaaans-front-airy-sitting-skinny-jeans-1-jacket-2.svg', { name: 'humaaans', head: 'front/airy', bottom: 'sitting/skinny-jeans-1', body: 'jacket-2' })
